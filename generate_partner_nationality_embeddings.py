...
# Process partner nationality data
levels = [
    ("partner_nationalities.csv", "partner_nationality")
]
...
for file_path, level in levels:
    ...
    for _, row in df.iterrows():
        ...
        metadata["nationality"] = row["name_en"]
...
print("All partner nationality embeddings uploaded to Pinecone.")
