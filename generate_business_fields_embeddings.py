...
# Process each level of business field data
levels = [
    ("employee_ranges.csv", "employee_range"),
    ("employee_ranges_group.csv", "employee_range_group"),
    ("business_types.csv", "business_type")
]
...
for file_path, level in levels:
    ...
    for _, row in df.iterrows():
        ...
        if level == "employee_range":
            metadata["range"] = row["range"]
        elif level == "employee_range_group":
            metadata["range"] = row["range"]
        elif level == "business_type":
...
print("All business field embeddings uploaded to Pinecone.")
